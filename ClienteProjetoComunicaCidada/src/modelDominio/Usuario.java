...
public class Usuario implements Serializable {
    ...
    public static void setUsuarioLogado (Usuario usuarioLogadoTela) {
        usuarioLogado = usuarioLogadoTela;
    }
    ...
    public String toString() {
        return "Usuario{" + "idUsuario=" + idUsuario + ", nome=" + nome + ", cpf=" + cpf + ", telefone=" + telefone + ", tipo=" + tipo + ", login=" + login + ", senha=" + senha + '}';
    }
